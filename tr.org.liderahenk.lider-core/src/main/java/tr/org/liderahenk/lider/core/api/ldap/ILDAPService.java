...
public interface ILDAPService {	
	 ...
	 * @param recursive true if SUBTREE scope, false if ONE_LEVEL 
	 * @return entries matching, empty otherwise
	 * @throws LdapException
	 */
	List<String> getChilds(String baseDn, String attributeName,
	 ...
	 * 
	 * @param entryDn
	 * @param attributes to be returned in entry
	 ...
	 * @throws LdapException
	 */
	String getDN(String baseDn, String attributeName,
			String attributeValue) throws LdapException;
	
	
	/**
	 * Get dn of entry with matching jid attribute value
	 * Jid attribute name was described in lider configuration file
	...
	void addEntry(String newDn, Map<String, String[]> attributes)
			throws LdapException;
	 ...
	 * @throws LdapException
	 */
	void updateEntry(String entryDn, String attribute, String value)
			throws LdapException;
	
	void updateEntryAddAtribute(String entryDn, String attribute, String value)
			throws LdapException;
	void updateEntryRemoveAttribute(String entryDn, String attribute)
			throws LdapException;
	...
	List<LdapEntry> search(String attributeName, String attributeValue,
...
//	void deleteEntry(Dn dn) throws LdapException;
