...
public interface ITaskManager {
	 ...
	 * @return String[] of tasks created as a result of {@link IRestRequest},
	 *         will be a single task for single node task, or all subtask id's
	 *         in case of a subtree request creating subtasks
	 ...
	 *             during {@link ITaskService} operations
	 * @throws TaskSubmissionFailedException
	 *             during {@link ITaskManager} operations
	 */
	void updateTaskPriority(String currentUser, String id, Integer priority)
			throws TaskServiceException, TaskSubmissionFailedException;

	void updateAhenk(String currentUser, String agentDn, Set<String> plugins) throws TaskSubmissionFailedException;
