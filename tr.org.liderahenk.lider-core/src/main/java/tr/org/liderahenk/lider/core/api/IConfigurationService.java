...
public interface IConfigurationService {
	 ...
	 * @deprecated use {@link IConfigurationService#getAuthLdapUserObjectClasses()} and {@link IConfigurationService#getAuthLdapUserAttribute()}
	 */
	...
	/**
	 * 
	 * @return comma separated ldap user object classes to be used in search filter for authentication
	 *   
	 */
