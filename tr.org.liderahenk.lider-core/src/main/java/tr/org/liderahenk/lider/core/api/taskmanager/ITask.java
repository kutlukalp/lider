...
/**
 * ITask is the core component of request processing in Lider and agent.
 * 
...
public interface ITask extends Serializable {
	...
	/**
	 * 
	 * @return true if task is still in progress, or false if it is already
	 *         finished
	 */
	boolean isActive();
	...
	/**
	 * 
	 * @return date that this tasks {@link #getCommState()} will be marked as
	 *         {@link TaskCommState#AGENT_TIMEDOUT}
	 */
	Date getTimeout();
	...
	/**
	 * 
	 * @return parent task id, if this task is a subtask, i.e. created from a
	 *         root request with a subtree-search implied directive in
	 *         {@link IRestRequest#getResource()}/
	 *         {@link IRestRequest#getAccess()}
	 */
	String getParentTaskId();

	/**
	 * 
	 * @return target agent jid of task <b>Only English characters supported</b>
	 */
	String getTargetJID();

	/**
	 * 
	 * @return true if this is a parent task containing sub tasks, false
	 *         otherwise
	 */
	boolean isParent();
