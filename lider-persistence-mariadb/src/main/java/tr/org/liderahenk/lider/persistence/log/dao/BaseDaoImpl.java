...
//	public BaseDaoImpl() {
//		/*
//		 * Type t = getClass().getGenericSuperclass(); ParameterizedType pt =
...
//		return em
//				.createQuery("select model from " + obj.getName() + " model where model." + propertyName
//						+ "= :propertyValue", obj)
//				.setParameter("propertyValue", value).setMaxResults(maxResults).getResultList();
//	}
//
//	@Override
//	public List<T> findByProperties(Class<T> obj, Map<String, Object> propertiesMap, List<PropertyOrder> orders,
//			Integer maxResults) {
...
//	}
	...
	public List<? extends T> findAll(Class<? extends T> obj, int maxResults) {
		return em.createQuery("select model from " + obj.getName() + " model", obj).setMaxResults(maxResults)
				.getResultList();
	}
	...
	@Override
	public List<? extends T> findByProperty(Class<? extends T> obj, String propertyName, Object value, int maxResults) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<? extends T> findByProperties(Class<? extends T> obj, Map<String, Object> propertiesMap,
